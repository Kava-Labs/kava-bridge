...
type JoinSessionMessage_JoinSigningSessionMessage struct {
	JoinSigningSessionMessage *JoinSigningSessionMessage `protobuf:"bytes,2,opt,name=join_signing_session_message,json=joinSigningSessionMessage,proto3,oneof" json:"join_signing_session_message,omitempty"`
}
type JoinSessionMessage_JoinKeygenSessionMessage struct {
	JoinKeygenSessionMessage *JoinKeygenSessionMessage `protobuf:"bytes,3,opt,name=join_keygen_session_message,json=joinKeygenSessionMessage,proto3,oneof" json:"join_keygen_session_message,omitempty"`
}
type JoinSessionMessage_JoinResharingSessionMessage struct {
	JoinResharingSessionMessage *JoinReSharingSessionMessage `protobuf:"bytes,4,opt,name=join_resharing_session_message,json=joinResharingSessionMessage,proto3,oneof" json:"join_resharing_session_message,omitempty"`
}
...
var fileDescriptor_c5a0677ae04bb2c7 = []byte{
	...
	,
}
